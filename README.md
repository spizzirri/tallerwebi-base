...
### Java
Java es el lenguaje de programación con el que trabajaremos. El proyecto esta configurado para funcionar con la version 21 de Java (LTS).
* Descargar el JDK para el sistema operativo en uso: [JDK 21 Temurin para Linux/Windows](https://adoptium.net/temurin/releases/?version=21).
...
* Configurar una variable de entorno con la clave `JAVA_HOME` indicando en el valor, la ruta donde se descomprimió el archivo descargado. 
    * Ejemplo: `C:\java\jdk-21` (en Windows) o `/home/java/jdk-21` (en Linux).
...
* Es requisito tener instalado Java (mínimo Java 17 para Maven, Java 21 para el proyecto) y configuradas las variables de entorno (`JAVA_HOME` y `PATH`).
...
* Java 21 (LTS)
* Spring 6.2.19
* Thymeleaf 3.1.2.RELEASE (spring6)
* Embedded Jetty Server EE10 12.0.14
...
* Mockito 5.3.1
* Playwright 1.36.0
* PMD 3.26.0 (PMD 7.7.0) & CPD
* Checkstyle 10.x (plugin 3.6.0, Google Style)
