...
public class RequisitosJuegos {
    ...
    public RequisitosJuegos() {}

    public RequisitosJuegos(String id, String nombre, Map<String, Double> requisitosMinimos, Map<String, Double> requisitosRecomendados) {
        this.id = id;
        this.nombre = nombre;
